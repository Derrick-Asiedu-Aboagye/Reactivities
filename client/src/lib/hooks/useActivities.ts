...
export const useActivities = (id?: string) => {
    ...
    const { data: activitiesGroup, isLoading, isFetchingNextPage, fetchNextPage, hasNextPage } = useInfiniteQuery<PageList<Activity, string>>({
    ...
    const createActivity = useMutation({
        mutationFn: async (activity: object) => { //activity: Activity
