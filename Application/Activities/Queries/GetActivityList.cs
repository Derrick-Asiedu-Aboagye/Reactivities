...
{
    public class Query : IRequest<Results<PageList<ActivityDto, DateTime?>>>
    {
        public required ActivityParams Params { get; set; }
    }

    public class Handler(AppDbContext context, IMapper mapper, IUserAccessor userAccessor)
        : IRequestHandler<Query, Results<PageList<ActivityDto, DateTime?>>>
    {
        public async Task<Results<PageList<ActivityDto, DateTime?>>> Handle(Query request, CancellationToken cancellationToken)
        {
            ...
            return Results<PageList<ActivityDto, DateTime?>>.Success(
